# Generated by Django 5.1.4 on 2025-01-23 15:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('آپارتمان', 'Apartment'), ('خانه', 'House')], default='آپارتمان', max_length=50, verbose_name='نوع')),
                ...
                ('post_date', models.DateTimeField(null=True, verbose_name='تاریخ پست')),
                ...
                ('floor_area', models.IntegerField(null=True, verbose_name='متراژ سازه')),
                ('elevator', models.BooleanField(default=False, null=True, verbose_name='آسانسور')),
                ('warehouse', models.BooleanField(default=False, null=True, verbose_name='انباری')),
                ('is_approved', models.BooleanField(default=False, verbose_name='وضعیت تایید')),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='properties.category', verbose_name='دسته بندی')),
